...
csv_file = "results/%s/%s/%s-rmse.csv" %(set_name, model_name, result_name)
print(result_name)
...
fig.tight_layout()
fig.savefig('results/%s/%s/%s-rmse.pdf' %(set_name, model_name, result_name))
result_file = "results/%s/%s/%s-predictions.csv" %(set_name, model_name, result_name)
...
for set_n, table in result_data.groupby('set'):
    ...
    snsplot_path = "results/%s/%s/%s_graph.png"%(set_name, model_name, result_name)
